...
void ProcessManager::addProcess(string process_name, string creation_time)
{
    ...
    shared_ptr<Process> process(new Process(process_id_counter, process_name, creation_time,
          -1, min_instructions, max_instructions, min_mem_per_proc, max_mem_per_proc));
    ...
    // moved generatePrintCommands within process constructor
